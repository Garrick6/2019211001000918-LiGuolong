    ...
    <div class="table-responsive col-sm-10">
      <table class="table table-condensed">
        ...
        <tr>
          ...
          <td>${o.orderDate}</td>
          <%
            com.LiGuolong.model.Order o=(com.LiGuolong.model.Order)pageContext.findAttribute("o");
            int userId=o.getCustomerId();
            java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
            com.LiGuolong.dao.UserDao userDao=new com.LiGuolong.dao.UserDao();
          ...
          <td class="cart_total">
            <%
              ...
              String paymentType=com.LiGuolong.model.Payment.findByPaymentId(con,n);
            %>
